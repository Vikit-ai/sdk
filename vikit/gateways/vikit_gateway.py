...
class VikitGateway(MLModelsGateway):
    ...
    async def get_music_generation_keywords_async(self, text) -> str:
        ...
        I want you to act as an English keyword generator for Midjourney's artificial intelligence program. 
        Your job is to provide detailed and creative descriptions that will inspire unique and interesting 
        images from the AI for a video. Keep in mind that the AI is capable of understanding a wide range of 
        language and can interpret abstract concepts, so feel free to be as imaginative and descriptive as possible. 
        Avoid repeating keywords. The more detailed and imaginative your descriptions, the more interesting the resulting image will be.
        Here is the sentence from which to extract keywords: {prompt}.
        """
