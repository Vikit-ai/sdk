...
class BuildOutputAssertor:
    ...
    def assert_exists_generated_video(self, nb_files_expected):
        ...
        """
        assert len(self._generated_videos) == nb_files_expected, (
            f"Expected {nb_files_expected} generated videos, found {len(self._generated_videos)}"
        )
    ...
    def assert_exists_transitions(self, nb_files_expected):
        ...
        """
        assert len(self._transitions) == nb_files_expected, (
            f"Expected {nb_files_expected} transition videos, found {len(self._transitions)}"
        )
    ...
    def assert_exists_child_composite_videos(self, nb_files_expected):
        ...
        """
        assert len(self._child_composite_videos) == nb_files_expected, (
            f"Expected {nb_files_expected} composite videos, found {len(self._child_composite_videos)}"
        )
    ...
    def assert_exists_root_composite_videos(self, nb_files_expected):
        ...
        - <video_title>_comp-*.mp4
        """
        assert len(self._root_composite_videos) == nb_files_expected, (
            f"Expected {nb_files_expected} composite videos, found {len(self._root_composite_videos)}"
        )
    ...
    def assert_exists_imported_videos(self, nb_files_expected):
        ...
        """
        assert len(self._imported_videos) == nb_files_expected, (
            f"Expected {nb_files_expected} imported videos, found {len(self._imported_videos)}"
        )
    ...
    def assert_exists_prompt_based_videos(self, nb_files_expected):
        ...
        """
        assert len(self._prompt_based_videos) == nb_files_expected, (
            f"Expected {nb_files_expected} prompt based videos, found {len(self._prompt_based_videos)}"
        )
    ...
    def assert_exists_raw_text_videos(self, nb_files_expected):
        ...
        """
        assert len(self._raw_text_videos) == nb_files_expected, (
            f"Expected {nb_files_expected} raw text videos, found {len(self._raw_text_videos)}"
        )
